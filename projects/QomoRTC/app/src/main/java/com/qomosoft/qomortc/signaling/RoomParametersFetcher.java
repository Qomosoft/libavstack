...
public class RoomParametersFetcher {
    ...
    private void roomHttpResponseParse(String response) {
        ...
        try {
            ...
            events.onSignalingParametersError("Room JSON parsing error: " + e.getMessage());
        } catch (IOException e) {
            events.onSignalingParametersError("Room IO error: " + e.getMessage());
        }
    }
